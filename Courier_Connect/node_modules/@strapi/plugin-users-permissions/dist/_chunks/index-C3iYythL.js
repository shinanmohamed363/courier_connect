      ...
      [
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-D0wS054s.js")),
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-CuvIhX1e.js")),
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-LdWx-SAe.js")).then((mod) => ({
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-CLDK4fmy.js")).then((mod) => ({
...
exports.index = index;
//# sourceMappingURL=index-C3iYythL.js.map
