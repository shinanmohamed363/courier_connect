...
const indexUvlzzkEs = require("./index-UvlzzkEs-Be9Y8EXt.js");
...
const index = require("./index-C3iYythL.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = indexUvlzzkEs.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(indexUvlzzkEs.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(indexUvlzzkEs.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-CuvIhX1e.js.map
